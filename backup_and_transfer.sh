...
echo "" >> "$install_script"
echo "# Install all packages listed in package_list.txt" >> "$install_script"
...
echo "To install these packages on another computer, transfer package_list.txt and $install_script to that computer, and then run ./$install_script"
